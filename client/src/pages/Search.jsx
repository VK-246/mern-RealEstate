...
import ListingItem from '../components/ListingItem'; // for displaying listing items
      ...
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            ...
            <div className='flex gap-2'>
              <input type='checkbox' id='sale' className='w-5' checked={sidebardata.type === 'sale'}/>
              <span>Sale</span>
            </div>
            <div className='flex gap-2'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <select id='sort_order'  onChange={handleChange}
              defaultValue={'created_at_desc'}className='border rounded-lg p-3'>
